...
*/case class Props(direction:String, active:Boolean=false, animation:Boolean=true,
  caption:ReactElement=null, onAnimateOutEnd:REventIAny=null) extends BoostrapMixinProps
def apply(direction:String, active:Boolean=false, animation:Boolean=true,
  caption:ReactElement=null, onAnimateOutEnd:REventIAny=null, ref: js.UndefOr[String] = "",
